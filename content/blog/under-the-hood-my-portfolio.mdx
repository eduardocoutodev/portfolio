...
<section className="space-y-4 mt-4"> 
  ...
  <p>
    In this article, I'll walk you through the technology stack behind my own <a href="https://github.com/eduardocoutodev/portfolio" className="underline" target="_blank"> my portfolio website</a>,
...
Feel free to explore <a href="https://github.com/eduardocoutodev/portfolio" className="underline" target="_blank"> my portfolio's source code on GitHub </a> to see how all these pieces fit together in practice.
